          ...
          <div className="text-center max-w-md">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[var(--av-primary)] text-white rounded-lg font-medium hover:bg-[var(--av-primary-hover)] transition"
              >
                <RefreshCw size={18} />
                Try Again
              </button>
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-white text-black rounded-lg font-medium hover:bg-white transition"
              >
                <Home size={18} />
                Go to Dashboard
              </button>
