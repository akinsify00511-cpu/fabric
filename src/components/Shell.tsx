  ...
  return (
    <div className="min-h-screen av-backdrop">
      <aside className="hidden md:flex w-60 shrink-0 border-r flex-col fixed inset-y-0 left-0 z-30" style={{ background: 'rgba(255,255,255,0.80)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', borderColor: 'var(--av-glass-border)' }}>
        ...
        <div className="px-3 pb-2"><a href="/pricing" className="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-gradient-to-r from-[#4285F4] to-[#8B5CF6] text-white text-sm font-medium hover:shadow-[var(--av-shadow-md)] transition"><Crown size={16} /><span>Upgrade to Pro</span></a></div>
