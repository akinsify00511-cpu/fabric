...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/app/requests', label: 'Requests', icon: ClipboardList, toolKey: 'crm' },
      { to: '/app/quotes', label: 'Quotes', icon: FileText, toolKey: 'crm' },
      { to: '/app/orders', label: 'Orders', icon: PackageOpen, toolKey: 'crm' },
      ...
      { to: '/app/discovery', label: 'Discovery', icon: Search, toolKey: 'social' },
  ...
  },
  {
    ...
    defaultOpen: false,
    items: [
      { to: '/app/finance', label: 'Finance & Invoices', icon: Wallet, toolKey: 'finance' },
      ...
      { to: '/app/receipts', label: 'Receipts', icon: ScanLine, toolKey: 'finance' },
  ...
  },
  {
    ...
    defaultOpen: false,
    items: [
      { to: '/app/organization', label: 'Organization', icon: Landmark, toolKey: 'people' },
