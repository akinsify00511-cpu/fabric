    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-black/[0.06] p-4 relative">
        <div className="flex gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[var(--av-primary, #0891B2)] to-purple-500 flex items-center justify-center text-white text-sm font-medium shrink-0">
          ...
          <div className="flex-1">
            <div className="relative">
              <textarea
                ...
                className="w-full p-3 rounded-lg border border-black/10 resize-none text-sm focus:outline-none focus:border-[var(--av-primary, #0891B2)]"
                rows={3}
              />
                      ...
                      <button
                        ...
                        className={`w-full flex items-center gap-2 px-2 py-2 rounded-lg text-left transition ${
                          selectedMentionIndex === idx 
                            ? 'bg-[var(--av-primary, #0891B2)]/10 text-[var(--av-primary, #0891B2)]' 
                            : 'hover:bg-black/10'
                        }`}
                      >
            ...
            <div className="flex items-center justify-between mt-2">
              <div className="flex items-center gap-2">
                <button 
                  className="p-1.5 rounded hover:bg-black/10 text-[var(--av-primary, #0891B2)]"
