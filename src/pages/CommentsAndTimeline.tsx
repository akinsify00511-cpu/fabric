    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-black/[0.06] p-4 relative">
        <div className="flex gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#4285F4] to-purple-500 flex items-center justify-center text-white text-sm font-medium shrink-0">
          ...
          <div className="flex-1">
            <div className="relative">
              <textarea
                ...
                className="w-full p-3 rounded-lg border border-black/10 resize-none text-sm focus:outline-none focus:border-[#4285F4]"
                rows={3}
              />
