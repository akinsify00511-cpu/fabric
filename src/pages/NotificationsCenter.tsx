        ...
        <div className="flex items-center gap-2">
          {unreadCount > 0 && (
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-lg bg-[var(--av-primary, #0891B2)] text-white text-sm"
            >
              <CheckCheck size={16} />
              Mark all read
            </button>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium ${
            filter === 'all' ? 'bg-[var(--av-primary, #0891B2)] text-white' : 'bg-white border border-black/10'
          }`}
        >
          All
        </button>
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium ${
            filter === 'unread' ? 'bg-[var(--av-primary, #0891B2)] text-white' : 'bg-white border border-black/10'
          }`}
        >
