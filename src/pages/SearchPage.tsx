      ...
      <div className="sticky top-0 bg-white z-10 pb-4 mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-12 py-4 rounded-2xl border border-black/10 text-lg focus:outline-none focus:border-[#4285F4]"
            autoFocus
          />
          {query && (
            <button
              ...
              <button
                ...
                className={`w-full p-4 rounded-xl border transition text-left ${
                  selectedIndex === suggestions.length + idx 
                    ...
                    : 'border-black/[0.06] hover:border-[#4285F4] hover:shadow-lg'
                }`}
              >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 rounded-xl bg-[#4285F4] text-white font-medium"
              >
                Save
              </button>
            </div>
