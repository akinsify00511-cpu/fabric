    ...
    <div className="max-w-4xl mx-auto pb-20">
      ...
      <div className="sticky top-0 bg-white z-10 pb-4 mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-12 py-4 rounded-2xl border border-black/10 text-lg focus:outline-none focus:border-[var(--av-primary, #0891B2)]"
            autoFocus
          />
          {query && (
            <button
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left transition ${
                      selectedIndex === idx ? 'bg-[var(--av-primary, #0891B2)]/10 text-[var(--av-primary, #0891B2)]' : 'hover:bg-black/10'
                    }`}
                  >
      ...
      {loading ? (
        <div className="text-center py-20">
          <div className="w-12 h-12 mx-auto rounded-full border-4 border-black/10 border-t-[var(--av-primary, #0891B2)] animate-spin mb-4" />
              ...
              <button
                ...
                className={`w-full p-4 rounded-xl border transition text-left ${
                  selectedIndex === suggestions.length + idx 
                    ? 'border-[var(--av-primary, #0891B2)] bg-[var(--av-primary, #0891B2)]/5 shadow-md' 
                    : 'border-black/[0.06] hover:border-[var(--av-primary, #0891B2)] hover:shadow-lg'
                }`}
              >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 rounded-xl bg-[var(--av-primary, #0891B2)] text-white font-medium"
              >
                Save
              </button>
            </div>
