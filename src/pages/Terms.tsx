    ...
    <div className="min-h-screen bg-[var(--avenize-offwhite)]">
      ...
      <header className="bg-white border-b border-black/5 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <h1 className="text-lg font-semibold text-[var(--avenize-black)]">Terms of Service</h1>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-2xl border border-black/5 p-8 md:p-12">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-3xl font-bold text-[var(--avenize-black)] mb-2">Terms of Service</h1>
          ...
          <div className="prose prose-slate max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="bg-gray-50 rounded-xl p-4 mt-4">
                <p className="font-medium text-[var(--avenize-black)]">Avenize, Inc.</p>
