    ...
    <div className="pb-20">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        <div className="bg-white rounded-xl border border-black/[0.06] p-4">
          ...
          <p className="text-xl font-bold text-[var(--av-primary, #0891B2)]">{formatCurrency(stats.totalReceivable)}</p>
        </div>
        <div className="bg-white rounded-xl border border-black/[0.06] p-4">
        ...
        loading ? (
          ...
          <div className="text-center py-12">
            <div className="w-16 h-16 rounded-2xl bg-[var(--av-primary, #0891B2)]/10 flex items-center justify-center mx-auto mb-4">
              <Receipt size={24} className="text-[var(--av-primary, #0891B2)]" />
            </div>
            ...
            {filteredInvoices.map((inv) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-xl border border-black/[0.06] p-4 hover:border-[var(--av-primary, #0891B2)]/20 cursor-pointer transition-colors"
                >
            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className="text-xs text-[var(--av-primary, #0891B2)] font-medium"
                  >
                    + Add Item
                  </button>
                </div>
              ...
              <div className="bg-white rounded-xl p-4 space-y-2">
                ...
                <div className="flex justify-between font-semibold text-lg pt-2 border-t border-black/10">
                  <span>Total</span>
                  <span className="text-[var(--av-primary, #0891B2)]">{formatCurrency(totals.total)}</span>
                </div>
              </div>
            ...
            <div className="p-4 space-y-4">
              <div className="bg-white rounded-xl p-4">
                ...
                <p className="text-sm mt-2">
                  Balance Due: <span className="font-semibold text-[var(--av-primary, #0891B2)]">{formatCurrency(selectedInvoice.balance)}</span>
                </p>
              </div>
