        ...
        <div className="bg-white rounded-2xl border border-black/[0.06] p-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button className="flex items-center gap-2 p-3 rounded-xl hover:bg-black/10 text-left">
              <Plus size={18} className="text-[var(--av-primary, #0891B2)]" />
              <span className="text-sm">Report Issue</span>
            </button>
            <button className="flex items-center gap-2 p-3 rounded-xl hover:bg-black/10 text-left">
              <Bell size={18} className="text-[var(--av-primary, #0891B2)]" />
              <span className="text-sm">Announcement</span>
            </button>
            <button className="flex items-center gap-2 p-3 rounded-xl hover:bg-black/10 text-left">
              <FileText size={18} className="text-[var(--av-primary, #0891B2)]" />
              <span className="text-sm">New SOP</span>
            </button>
            <button className="flex items-center gap-2 p-3 rounded-xl hover:bg-black/10 text-left">
              <ScrollText size={18} className="text-[var(--av-primary, #0891B2)]" />
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={() => showToast('SOP creation coming soon!', 'info')} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--av-primary, #0891B2)] text-white text-sm">
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={() => showToast('Workflow builder coming soon!', 'info')} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--av-primary, #0891B2)] text-white text-sm">
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={() => showToast('Add compliance item coming soon!', 'info')} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--av-primary, #0891B2)] text-white text-sm">
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={() => showToast('Document upload coming soon!', 'info')} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--av-primary, #0891B2)] text-white text-sm">
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={() => showToast('Department management coming soon!', 'info')} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--av-primary, #0891B2)] text-white text-sm">
