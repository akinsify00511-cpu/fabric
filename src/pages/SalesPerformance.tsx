  ...
  return (
    <div className="pb-20">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-semibold text-[var(--avenize-black)]">Sales Performance</h1>
    ...
    <div>
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-black/[0.06] p-4 mb-4 space-y-3">
          ...
          <button type="submit" className="w-full py-2 rounded-lg bg-[var(--avenize-primary)] text-white">Create Target</button>
        </form>
      )}
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={() => setShowRuleForm(!showRuleForm)} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--avenize-primary)] text-white text-sm">
      ...
      {showRuleForm && (
        <form onSubmit={handleRuleSubmit} className="bg-white rounded-2xl border border-black/[0.06] p-4 mb-4 space-y-3">
          ...
          <button type="submit" className="w-full py-2 rounded-lg bg-[var(--avenize-primary)] text-white">Create Rule</button>
        </form>
      )}
