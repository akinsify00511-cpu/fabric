    ...
    <div>
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-black/[0.06] p-4 mb-4 space-y-3">
          ...
          <button type="submit" className="w-full py-2 rounded-lg bg-[var(--av-primary, #475569)] text-white">Create Target</button>
        </form>
      )}
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button onClick={() => setShowRuleForm(!showRuleForm)} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--av-primary, #475569)] text-white text-sm">
      ...
      {showRuleForm && (
        <form onSubmit={handleRuleSubmit} className="bg-white rounded-2xl border border-black/[0.06] p-4 mb-4 space-y-3">
          ...
          <button type="submit" className="w-full py-2 rounded-lg bg-[var(--av-primary, #475569)] text-white">Create Rule</button>
        </form>
      )}
