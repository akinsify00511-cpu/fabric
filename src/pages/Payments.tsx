    ...
    <div className="pb-20">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        ...
        <div className="bg-white rounded-xl border border-black/[0.06] p-4">
          ...
          <p className={`text-xl font-bold ${netBalance >= 0 ? 'text-[var(--av-primary, #475569)]' : 'text-red-600'}`}>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          <div className="w-16 h-16 rounded-2xl bg-[var(--av-primary, #475569)]/10 flex items-center justify-center mx-auto mb-4">
            <ReceiptText size={24} className="text-[var(--av-primary, #475569)]" />
          </div>
            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="0.00"
                  className="w-full px-4 py-3 rounded-xl border border-black/10 text-lg font-semibold focus:outline-none focus:ring-2 focus:ring-[var(--av-primary, #475569)]/30"
                />
              </div>
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-3 py-2.5 rounded-xl border text-sm ${
                        newPayment.method === key
                          ? 'border-[var(--av-primary, #475569)] bg-[var(--av-primary, #475569)]/5 text-[var(--av-primary, #475569)]'
