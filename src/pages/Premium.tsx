      ...
      <div className="max-w-6xl mx-auto pb-20">
        ...
        <div className="text-center py-12 px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-black mb-4">
            Choose Your <span className="text-transparent bg-clip-text bg-gradient-to-r to-[var(--av-primary)] to-[var(--av-accent)]">Plan</span>
          </h1>
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-lg text-sm font-medium transition-all ${
                billingCycle === 'monthly' 
                  ? 'bg-[var(--av-primary)] text-white shadow-sm' 
              ...
              <div
                ...
                className={`bg-white rounded-2xl border-2 p-5 cursor-pointer transition-all hover:shadow-lg hover:-translate-y-1 ${
                  plan.popular 
                    ...
                    : 'border-black/5 hover:border-[var(--av-primary)]/20'
                }`}
              >
                {plan.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                    <span className="px-3 py-1 bg-gradient-to-r to-[var(--av-primary)] to-[var(--av-accent)] text-white text-xs font-semibold rounded-full">
                      Most Popular
                    </span>
                  </div>
                )}
                ...
                <button className={`w-full py-2.5 rounded-xl text-sm font-medium transition-all ${
                  plan.popular
                    ? 'bg-gradient-to-r to-[var(--av-primary)] to-[var(--av-accent)] text-white hover:shadow-lg'
            ...
            <table className="w-full">
                ...
                <tr>
                  ...
                  {PLANS.map(plan => (
                    <th key={plan.id} className={`p-4 text-center font-medium ${
                      plan.popular ? 'bg-[var(--av-primary)]/5 text-[var(--av-primary)]' : 'text-black'
                    }`}>
                      {plan.name}
                    </th>
                  ))}
              ...
              <tbody className="divide-y divide-black/5">
                  ...
                  {PLANS.map(plan => {
                    ...
                    return (
                      <td key={plan.id} className={`p-4 text-center font-bold ${
                        plan.popular ? 'bg-[var(--av-primary)]/5' : ''
                      }`}>
                ...
                <tr>
                  ...
                  <td className="p-4 text-center bg-[var(--av-primary)]/5">5</td>
                  <td className="p-4 text-center">15</td>
                  <td className="p-4 text-center">30</td>
                  <td className="p-4 text-center bg-[var(--av-primary)]/5">75</td>
                ...
                <tr className="bg-black/[0.02]">
                  ...
                  <td className="p-4 text-center bg-[var(--av-primary)]/5">Single</td>
                  <td className="p-4 text-center">Single</td>
                  <td className="p-4 text-center">Multi</td>
                  <td className="p-4 text-center bg-[var(--av-primary)]/5">Multi</td>
                  <td className="p-4 text-center">Multi</td>
                </tr>
                <tr>
                ...
                <tr className="bg-black/[0.02]">
                  ...
                  <td className="p-4 text-center bg-[var(--av-primary)]/5">Email</td>
                  <td className="p-4 text-center">Priority</td>
                  <td className="p-4 text-center">Priority</td>
                  <td className="p-4 text-center bg-[var(--av-primary)]/5">Dedicated</td>
  ...
  return (
    <div className="max-w-2xl mx-auto pb-20">
      ...
      <div className="bg-white rounded-2xl  overflow-hidden mb-6">
        <div className="p-6 border-b border-black/5 bg-gradient-to-r to-[var(--av-primary)]/5 to-violet-50">
        ...
        <div className="p-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`flex-1 p-4 rounded-xl border-2 transition-all ${
                  billingCycle === 'monthly'
                    ? 'border-[var(--av-primary)] bg-[var(--av-primary)]/5'
          ...
          <button
            ...
            disabled={processing}
            className="w-full py-4 rounded-xl bg-gradient-to-r to-[var(--av-primary)] to-[var(--av-accent)] text-white font-semibold text-lg hover:shadow-lg hover:shadow-[var(--av-primary)]/30 transition disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {processing ? (
              <>
