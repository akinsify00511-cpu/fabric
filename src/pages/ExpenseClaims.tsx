        ...
        <div className="flex gap-2 mb-6">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium ${
              tab === 'my' ? 'bg-[var(--av-primary, #4285F4)] text-white' : 'bg-white border border-black/10'
            }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium ${
              tab === 'approvals' ? 'bg-[var(--av-primary, #4285F4)] text-white' : 'bg-white border border-black/10'
            }`}
          >
