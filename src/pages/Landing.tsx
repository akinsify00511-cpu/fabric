      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-r from-[#475569] via-[#475569] to-[#7C3AED] flex items-center justify-center">
...
function ChatMockup() {
  const messages = [
    { initials: "SC", name: "Site Crew", role: "IKM Project", message: "Project 90% done. Inspector photo attached. Awaiting your sign-off to invoice Alhaji.", color: "#475569" },
