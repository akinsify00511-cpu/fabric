            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={11}
                  className="w-full px-4 py-2.5 rounded-xl border border-black/10 focus:border-[var(--av-primary, #4285F4)] focus:ring-2 focus:ring-[var(--av-primary, #4285F4)]/20 outline-none"
                />
                <p className="text-xs text-black mt-1.5">
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  disabled={saving}
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[var(--av-primary, #4285F4)] text-white font-medium hover:opacity-90 disabled:opacity-50"
                >
                  <Save size={16} />
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-2.5 rounded-xl border border-black/10 focus:border-[var(--av-primary, #4285F4)] focus:ring-2 focus:ring-[var(--av-primary, #4285F4)]/20 outline-none resize-none"
                />
