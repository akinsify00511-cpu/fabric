    ...
    <div className="max-w-6xl mx-auto pb-20">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[var(--avenize-black)]">Workflows</h1>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-black/[0.06] p-12 text-center">
          ...
          <button
            onClick={() => setShowModal(true)}
            className="px-6 py-3 rounded-xl bg-[var(--avenize-primary)] text-white font-medium"
          >
            Create Workflow
          </button>
        </div>
                  ...
                  {form.steps.map((step, index) => {
                    ...
                    return (
                      <div key={step.id} className="p-4 bg-black/[0.02] rounded-xl flex items-start gap-3">
                        <div className="w-8 h-8 rounded-lg bg-[var(--avenize-primary)]/10 flex items-center justify-center text-[var(--avenize-primary)]">
