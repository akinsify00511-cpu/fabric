                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-sm text-black/50">
                        <span className={`px-2 py-0.5 rounded text-xs ${
                          gw.is_active ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-600'
                        }`}>
          ...
          <div className="p-6 space-y-4">
            {availableProviders.filter(p => !existingGateways.includes(p.id)).map(p => (
              <button
                ...
                className="w-full p-4 rounded-xl border border-black/10 hover:border-[var(--avenize-primary)] text-left flex items-center gap-4"
              >
