...
import { Users2, FolderKanban, Wallet, Contact, Boxes, BarChart3, Settings as SettingsIcon, Share2, CheckSquare, Award, DollarSign } from 'lucide-react'

const ITEMS = [
  { to: '/crm', label: 'CRM', icon: Users2, tint: 'bg-[#4F46E5]/10 text-[#4F46E5]', desc: 'Contacts & deals' },
  ...
  { to: '/projects', label: 'Projects', icon: FolderKanban, tint: 'bg-purple-500/10 text-purple-500', desc: 'Project management' },
