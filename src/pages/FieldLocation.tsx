  ...
  return (
    <div className="max-w-6xl mx-auto pb-20 space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">{online ? <Wifi className="text-[var(--av-success)]" size={16}/> : <WifiOff className="text-amber-600" size={16}/>} {queued > 0 && <span className="text-xs px-2 py-1 rounded-full bg-amber-100 text-amber-800">{queued} queued</span>}{isManager && <MotionButton onClick={() => setShowCreate(v => !v)} className="px-4 py-2 rounded-lg bg-black text-white flex items-center gap-2"><Plus size={16}/> Assign visit</MotionButton>}</div>
      </div>
