              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  {platform.connected ? (
                    ...
                    <button
                      onClick={() => connectSocialPlatform(platform)}
                      className="flex items-center gap-2 px-4 py-2 bg-[var(--av-primary, #0891B2)] text-white rounded-lg text-sm font-medium hover:opacity-90 transition-opacity"
                    >
                      Connect
          ...
          <div className="bg-white rounded-2xl w-full max-w-md">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-black/[0.1] rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--av-primary, #0891B2)]/20"
                />
              </div>
              <div>
            ...
            <div className="p-6 border-t border-black/[0.06] flex justify-end gap-3">
              ...
              <button
                ...
                disabled={saving}
                className="px-4 py-2 bg-[var(--av-primary, #0891B2)] text-white rounded-lg font-medium hover:opacity-90 disabled:opacity-50"
              >
