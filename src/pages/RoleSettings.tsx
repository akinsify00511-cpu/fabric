      ...
      <div className="bg-white rounded-2xl border border-black/[0.06] p-4 mb-6">
        {showNewForm ? (
          ...
          <button
            ...
            className="flex items-center gap-2 text-[var(--av-primary, #475569)] font-medium text-sm"
          >
            <Plus size={18} />
            Add Role
          </button>
                            ...
                            return (
                              ...
                              >
                                <input
                                  ...
                                  disabled={saving}
                                  className="w-4 h-4 rounded border-black/20 text-[var(--av-primary, #475569)] focus:ring-[var(--av-primary, #475569)]"
                                />
