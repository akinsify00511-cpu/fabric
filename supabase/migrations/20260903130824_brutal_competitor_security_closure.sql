...
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.builder_dashboard() FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.business_relationships(UUID,TEXT,UUID,INTEGER) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.create_capture(TEXT,TEXT,TEXT,UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.create_lead_request(UUID,TEXT,TEXT,TEXT,UUID,NUMERIC,TEXT,NUMERIC,TEXT,JSONB) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.create_quote(UUID,TEXT,JSONB,UUID,NUMERIC,NUMERIC,TIMESTAMPTZ,UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.create_sales_order(UUID,UUID,UUID,UUID,JSONB,NUMERIC,TEXT,UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.demand_pipeline(UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.demand_revenue(UUID,TIMESTAMPTZ,TIMESTAMPTZ) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.finalize_recording(TEXT,INTEGER,BIGINT,UUID,UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.generate_recording_signed_url(TEXT,INTEGER) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.get_meeting_reports(UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.increment_capture_view(UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.increment_saved_search_use(UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.increment_user_learning(UUID,TEXT) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.link_meeting_to_crm(UUID,TEXT,UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.log_security_event(TEXT,UUID,TEXT,TEXT,TEXT,UUID,JSONB,BOOLEAN) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.transition_demand(UUID,TEXT,TEXT) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.update_leave_balance(UUID,UUID,NUMERIC,TEXT) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.add_manual_time_entry(TEXT,TIMESTAMPTZ,TIMESTAMPTZ,BOOLEAN,TEXT[]) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.generate_mfa_backup_codes() FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.get_webhook_events() FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.seed_default_functional_roles(UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.seed_default_job_types(UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.seed_default_pipeline_stages(UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.update_daily_summary(DATE) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.builder_dashboard() TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.business_relationships(UUID,TEXT,UUID,INTEGER) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.create_capture(TEXT,TEXT,TEXT,UUID) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.create_lead_request(UUID,TEXT,TEXT,TEXT,UUID,NUMERIC,TEXT,NUMERIC,TEXT,JSONB) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.create_quote(UUID,TEXT,JSONB,UUID,NUMERIC,NUMERIC,TIMESTAMPTZ,UUID) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.create_sales_order(UUID,UUID,UUID,UUID,JSONB,NUMERIC,TEXT,UUID) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.demand_pipeline(UUID) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.demand_revenue(UUID,TIMESTAMPTZ,TIMESTAMPTZ) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.finalize_recording(TEXT,INTEGER,BIGINT,UUID,UUID) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.generate_recording_signed_url(TEXT,INTEGER) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.get_meeting_reports(UUID) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.increment_capture_view(UUID) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.increment_saved_search_use(UUID) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.increment_user_learning(UUID,TEXT) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.link_meeting_to_crm(UUID,TEXT,UUID) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.log_security_event(TEXT,UUID,TEXT,TEXT,TEXT,UUID,JSONB,BOOLEAN) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.transition_demand(UUID,TEXT,TEXT) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.update_leave_balance(UUID,UUID,NUMERIC,TEXT) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.add_manual_time_entry(TEXT,TIMESTAMPTZ,TIMESTAMPTZ,BOOLEAN,TEXT[]) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.get_webhook_events() TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.get_exchange_rate(TEXT,TEXT) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.convert_currency(NUMERIC,TEXT,TEXT) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
...
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.record_invoice_payment(UUID,NUMERIC,TEXT,TEXT,UUID) FROM PUBLIC'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'GRANT EXECUTE ON FUNCTION public.record_invoice_payment(UUID,NUMERIC,TEXT,TEXT,UUID) TO authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;