-- Restore the canonical Business Value Ledger after an accidental drop during ACL hardening.
-- Source: supabase/migrations/20260818220000_business_brain.sql at becd7e2bd066e4e18b8a44d8996c9dbdf2867842.
-- v_rule is explicitly declared because the canonical migration body references it in the loop.
